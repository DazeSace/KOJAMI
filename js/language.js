...
const dictionary = {
    ...
    "rs":{
        ...
        "location": "Локација",
        "location1":
            "Оптимални географски положај у Србији приближава вас купцима. Добро развијена индустрија транспорта и логистике има могућност да већину тржишта ЕУ цестом опслужи за мање од 24 сата.",
